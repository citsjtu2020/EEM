#include "constant.h"
string expID = "2057";       // Record the experiment ID number
...
int m = 50;                // Number of attributes in one pub.
...
int valDis = 1;              //The distribution of values in subs and pubs. 0:uniform + fixed width | 1: random width >= $width + Uniform | 2: Zipf + fixed width | 3: Normal + fixed width | 4: Normal + two ends
int valDom = 1000000;        // Cardinality of values.
double alpha = 0.8;            // Parameter for Zipf distribution.
...
// Rein
int buks = 1000;       // Number of buckets.
...
// AdaRein
const double falsePositiveRate = 0.0001;
int adarein_level = 10;
//PADA
const double waitTimeUpperThreshold = 17;
const double waitTimeLowerThreshold = 16;
const int windowSize = 50;
const double falsePositiveRateMax = 0.01;
const double falsePositiveRateMaxVariation = 0.0002;
